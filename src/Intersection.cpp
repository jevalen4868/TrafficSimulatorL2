...
void WaitingVehicles::permitEntryToFirstInQueue()
{
    ...
    std::promise<void> &vehProm {_promises.front()};
    std::shared_ptr<Vehicle> vehPtr {_vehicles.front()};
...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::promise<void> vehProm;
    std::future<void> vehFut {vehProm.get_future()};
    _waitingVehicles.pushBack(vehicle, std::move(vehProm));
